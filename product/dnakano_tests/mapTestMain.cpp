...
/*   Updated: 2021/07/24 16:31:37 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test_map(int& test_no) {
  ...
  ft::pair<int, std::string> ft_persons_sorted[10] = {
      ft::pair<int, std::string>(0, "dnakano"),
      ft::pair<int, std::string>(1, "nop"),
      ft::pair<int, std::string>(2, "bunjiro"),
      ft::pair<int, std::string>(3, "deedee"),
      ft::pair<int, std::string>(4, "sataharu"),
      ft::pair<int, std::string>(5, "marvin"),
      ft::pair<int, std::string>(6, "hoge"),
      ft::pair<int, std::string>(7, "fuga"),
      ft::pair<int, std::string>(8, "foobar"),
      ft::pair<int, std::string>(9, "norminette")};
  ft::map<int, std::string> ft_persons_sorted_map(ft_persons_sorted,
                                                ft_persons_sorted + 10);
  ...
  ft::pair<int, std::string> ft_persons_revsorted[10] = {
      ft::pair<int, std::string>(9, "dnakano"),
      ft::pair<int, std::string>(8, "nop"),
      ft::pair<int, std::string>(7, "bunjiro"),
      ft::pair<int, std::string>(6, "deedee"),
      ft::pair<int, std::string>(5, "sataharu"),
      ft::pair<int, std::string>(4, "marvin"),
      ft::pair<int, std::string>(3, "hoge"),
      ft::pair<int, std::string>(2, "fuga"),
      ft::pair<int, std::string>(1, "foobar"),
      ft::pair<int, std::string>(0, "norminette")};
  ft::map<int, std::string> ft_persons_revsorted_map(ft_persons_revsorted,
                                                   ft_persons_revsorted + 10);
  ...
  ft::pair<Hoge, Hoge> ft_fugas[10] = {
      ft::pair<Hoge, Hoge>(Hoge(0, 0), Hoge(0, 5)),
      ft::pair<Hoge, Hoge>(Hoge(1, 1), Hoge(1, 1)),
      ft::pair<Hoge, Hoge>(Hoge(2, 2), Hoge(2, 5)),
      ft::pair<Hoge, Hoge>(Hoge(3, 3), Hoge(3, 589)),
      ft::pair<Hoge, Hoge>(Hoge(4, 4), Hoge(4, 4)),
      ft::pair<Hoge, Hoge>(Hoge(5, 5), Hoge(5, 43)),
      ft::pair<Hoge, Hoge>(Hoge(6, 6), Hoge(6, 6)),
      ft::pair<Hoge, Hoge>(Hoge(7, 7), Hoge(7, 45)),
      ft::pair<Hoge, Hoge>(Hoge(8, 8), Hoge(8, 8)),
      ft::pair<Hoge, Hoge>(Hoge(9, 9), Hoge(9, 24))};
  ft::map<Hoge, Hoge> ft_fugas_map(ft_fugas, ft_fugas + 10);
  ...
  try {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      ft_res = ft_map.insert(ft_persons_sorted[i]);
      if (std_res.first->first != ft_res.first->first
        || std_res.first->second != ft_res.first->second
        || std_res.second != ft_res.second) {
        throw std::runtime_error("return value");
  ...
  try {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      ft_res = ft_map.insert(ft_persons_revsorted[i]);
      if (std_res.first->first != ft_res.first->first
        || std_res.first->second != ft_res.first->second
        || std_res.second != ft_res.second) {
        throw std::runtime_error("return value");
  ...
  try {
    ...
    ft::pair<ft::map<Hoge, Hoge>::iterator, bool> ft_res;

    for (int i = 0; i < 10; i++) {
      std_map.insert(hoges[i]);
      ft_map.insert(ft_hoges[i]);
      std_map.insert(fugas[i]);
      ft_map.insert(ft_fugas[i]);
    }
    // std_map[Hoge(42, 42)];
    // ft_map[Hoge(42, 42)];
    for (int i = 0; i < 10; i++) {
      // std::cout << std::endl;
      // std::cout << i << std::endl;
      // std::cout << " " << std_map[hoges[i].first] << std::endl;
      // std::cout << " " << std_map[fugas[i].first] << std::endl;
      // std::cout << " " << ft_map[ft_hoges[i].first] << std::endl;
      // std::cout << " " << ft_map[ft_fugas[i].first] << std::endl;
  ...
  try {
    ...
    ft_map.insert(ft_persons, ft_persons + 10);
    for (int i = 0; i < 10; i++) {
      if (std_map[persons[i].first] != ft_map[ft_persons[i].first]) {
        throw std::runtime_error("value");
      }
    }
    if (std_map.size() != ft_map.size() || std_map.empty() != ft_map.empty() ||
  ...
  try {
    ...
    ft_map.insert(ft_persons_sorted, ft_persons_sorted + 10);
    std_map.insert(persons, persons + 10);
    ft_map.insert(ft_persons, ft_persons + 10);
    for (int i = 0; i < 10; i++) {
      if (std_map[persons[i].first] != ft_map[ft_persons[i].first]) {
  ...
  try {
    ...
    ft_map.insert(ft_persons_map.begin(), ft_persons_map.end());
    for (int i = 0; i < 10; i++) {
      if (std_map[persons[i].first] != ft_map[ft_persons[i].first]) {
        throw std::runtime_error("value");
      }
  ...
  try {
    ...
    ft_map.insert(ft_persons_sorted_map.begin(), ft_persons_sorted_map.end());
    std_map.insert(persons_revsorted_map.begin(), persons_revsorted_map.end());
    ft_map.insert(ft_persons_revsorted_map.begin(), ft_persons_revsorted_map.end());
    for (int i = 0; i < 10; i++) {
      if (std_map[persons[i].first] != ft_map[ft_persons[i].first]) {
        throw std::runtime_error("value");
      }
  ...
  try {
    ...
    ft_map.insert(ft_hoges, ft_hoges + 10);
    for (int i = 0; i < 10; i++) {
      if (std_map[hoges[i].first] != ft_map[ft_hoges[i].first]) {
        throw std::runtime_error("value");
      }
  ...
  try {
    ...
    ft_map.insert(ft_hoges_map.begin(), ft_hoges_map.end());
    for (int i = 0; i < 10; i++) {
      if (std_map[hoges[i].first] != ft_map[ft_hoges[i].first]) {
        throw std::runtime_error("value");
      }
  ...
  try {
    ...
    ft_map.insert(ft_fugas_map.begin(), ft_fugas_map.end());
    for (int i = 0; i < 10; i++) {
      if (std_map[hoges[i].first] != ft_map[ft_hoges[i].first]) {
        throw std::runtime_error("value");
      }
  ...
  try {
    ...
    ft::map<int, std::string> ft_map(ft_persons, ft_persons + 10);
  ...
  try {
    ...
    ft::map<int, std::string> ft_map(ft_persons_revsorted_map.begin(),
                                     ft_persons_revsorted_map.end());
  ...
  try {
    ...
    ft::map<Hoge, Hoge> ft_map(ft_fugas, ft_fugas + 10);
  ...
  try {
    ...
    ft::map<Hoge, Hoge> ft_map(ft_fugas_map.begin(), ft_fugas_map.end());
  ...
  try {
    ...
    ft::map<Hoge, Hoge> ft_map2(ft_fugas, ft_fugas + 5);
  ...
  try {
    ...
    ft::map<Hoge, Hoge> ft_map(ft_hoges, ft_hoges + 5);
    ...
    for (int i = 0; i < 10; i++) {
      for (int j = 0; j < 10; j++) {
        if (comp_std(persons[i], persons[j]) !=
              comp_ft(ft_persons[i], ft_persons[j]) ||
            comp_std(persons[j], persons[i]) !=
              comp_ft(ft_persons[j], ft_persons[i]))
  ...
  try {
    ...
    for (int i = 0; i < 10; i++) {
      for (int j = 0; j < 10; j++) {
        if (comp_std(hoges[i], hoges[j]) != comp_ft(ft_hoges[i], ft_hoges[j]) ||
            comp_std(hoges[j], hoges[i]) != comp_ft(ft_hoges[j], ft_hoges[i]))
          throw std::runtime_error("comp");
      }
    }
  } catch (std::exception& e) {
  ...
  try {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      if (std_itr->first != ft_itr->first
        || std_itr->second != ft_itr->second) {
        throw std::runtime_error("find1");
      }
    }
    if (ft_map.find(42) != ft_map.end() || ft_map.find(-42) != ft_map.end()) {
      throw std::runtime_error("find2");
    }
    if (std_map.size() != ft_map.size() || std_map.empty() != ft_map.empty() ||
        0) {
      throw std::runtime_error("size");
  ...
  try {
    ...
    ft::map<Hoge, Hoge> ft_map(ft_hoges, ft_hoges + 5);
    ft::map<Hoge, Hoge> ft_map2(ft_fugas + 5, ft_fugas + 10);
  ...
  try {
    ...
    std::map<Hoge, Hoge> std_map2(fugas, fugas + 10);
    ft::map<Hoge, Hoge> ft_map(ft_hoges + 5, ft_hoges + 10);
    ft::map<Hoge, Hoge> ft_map2(ft_fugas, ft_fugas + 10);
    std::map<Hoge, Hoge>::iterator std_itr;
    ft::map<Hoge, Hoge>::iterator ft_itr;
  ...
  try {
    ...
    ft::map<Hoge, Hoge> ft_map;
    ft::map<Hoge, Hoge> ft_map2(ft_hoges, ft_hoges + 5);
    std::map<Hoge, Hoge>::iterator std_itr;
    ft::map<Hoge, Hoge>::iterator ft_itr;
  ...
  try {
    ...
    ft::map<Hoge, Hoge> ft_map(ft_fugas, ft_fugas + 10);
    ft::map<Hoge, Hoge> ft_map2(ft_hoges, ft_hoges + 10);
    std::map<Hoge, Hoge>::iterator std_itr;
    ft::map<Hoge, Hoge>::iterator ft_itr;
    ...
    for (int i = 0; i < 5; i++) {
        if (std_itr->first != ft_itr->first
          || std_itr->second != ft_itr->second
          || std_itr2->first != ft_itr2->first
          || std_itr2->second != ft_itr2->second) {
    ...
    while (std_itr2 != std_map.end()) {
      // if (*std_itr2 != *ft_itr2) {
      if (std_itr2->first != ft_itr2->first
        || std_itr2->second != ft_itr2->second) {
        throw std::runtime_error("value");
      }
      std_itr2++;
  ...
  try {
    ...
    for (int i = -9; i <= 10; i++) {
      ...
      if (std_itr != std_map.end()
        && (std_itr->first != ft_itr->first
          || std_itr->second != ft_itr->second)) {
  ...
  try {
    ...
    for (int i = -9; i <= 110; i++) {
      ...
      if (std_itr != std_map.end()
        && (std_itr->first != ft_itr->first
          || std_itr->second != ft_itr->second)) {
        throw std::runtime_error("upper_bound1");
      }
      if (std_itr == std_map.end() && ft_itr != ft_map.end()) {
        throw std::runtime_error("upper_bound2");
      }
    }
  } catch (std::exception& e) {
    throw std::runtime_error(e.what());
  ...
  for (int i = 0; i <= 20; i++) {
    for (int j = 0; j <= 10; j++) {
      ...
      try {
        ...
        ft_itr = ft_map.insert(ft_map.find(j * 2), ft::pair<int, int>(i, 42));
        if (std_itr->first != ft_itr->first
          || std_itr->second != ft_itr->second) {
          throw std::runtime_error("return value");
        }
    ...
    for (int j = i; j <= 10; j++) {
      ...
      try {
        ...
        for (std_first = std_map.begin(), ft_first = ft_map.begin();
          ...
          if (std_first->first != ft_first->first
            || std_first->second != ft_first->second) {
            throw std::runtime_error("value");
          }
        }
      } catch (std::exception& e) {
  ...
  try {
    ...
    for (std_itr = std_map.begin(), ft_itr = ft_map.begin();
      ...
      if (std_itr->first != ft_itr->first
        || std_itr->second != ft_itr->second) {
        throw std::runtime_error("iterator1");
      }
    }
    if (ft_itr != ft_map.end()) {
      throw std::runtime_error("iterator2");
    }

    for (std_ritr = std_map.rbegin(), ft_ritr = ft_map.rbegin();
         std_ritr != std_map.rend(); ++std_ritr, ++ft_ritr) {
      if (std_ritr->first != ft_ritr->first
        || std_ritr->second != ft_ritr->second) {
        throw std::runtime_error("rev iterator1");
      }
    }
    if (ft_ritr != ft_map.rend()) {
      throw std::runtime_error("rev iterator2");
    }

    for (std_citr = std_map.begin(), ft_citr = ft_map.begin();
         std_citr != std_map.end(); ++std_citr, ++ft_citr) {
      if (std_citr->first != ft_citr->first
        || std_citr->second != ft_citr->second) {
        throw std::runtime_error("iterator3");
      }
    }
    if (ft_citr != ft_map.end()) {
      std::cout << std::endl;
      std::cout << ft_citr->first << std::endl;
      std::cout << ft_map.end()->first << std::endl;
      throw std::runtime_error("iterator4");
    }
    ...
    for (std_critr = std_map.rbegin(), ft_critr = ft_map.rbegin();
      ...
      if (std_critr->first != ft_critr->first
        ...
        throw std::runtime_error("rev iterator3");
      }
    }
    if (ft_critr != ft_map.rend()) {
      throw std::runtime_error("rev iterator4");
    }
